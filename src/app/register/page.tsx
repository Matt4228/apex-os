...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-cneter justify-center bg-slate-50">
            <div className="w-full max-w-md bg-white rounded-x1 border border-slate-200 p-8">
                <div className="mb-8">
                    <h1 className="text-2x1 font-semibold text-slate-900">Create your account</h1>
                    <p className="text-slate-500 text-sm mt-1">Start tracking your goals and build better habits</p>
                </div>
                ...
                <form action={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" disabled={loading}>
                        {loading ? "Creating accoutn..." : "Create account"}
                    </Button>
                </form>
